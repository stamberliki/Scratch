...
public class interface_implement extends AndroidApplication implements tess_interface {
        ...
        switch (requestCode) {
            case 1:
                if (resultCode ==  RESULT_OK  ) {
                    ...
                    Cursor cursor = app.getContentResolver().query(selectedImage, filePathColumn, null, null, null);
                    cursor.moveToFirst();
